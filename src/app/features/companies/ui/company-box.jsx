...
function CompanyBox({ company: { joined, role, company } }) {
  ...
  return (
    <div className="group rounded-[1.4rem] border border-main-border-color bg̣-white shadow-[0_6px_18px_rgba(15,23,42,0.06)] transition-all duration-200 hover:shadow-[0_10px_22px_rgba(15,23,42,0.1)]">
      <div className="p-[1.8rem] flex flex-col gap-[1.4rem]">
        <div className="flex items-start justify-between gap-4">
          ...
          <span className="text-[1.2rem] px-3 py-1 rounded-full border border-main-border- text-main-text-color font-medium bg-white">
            {rewriteRoles(role)}
          </span>
        </div>
        ...
        <p className="text-[1.4rem] text-secondary-text-color max-h-[6.6rem] overflow-hidden">
          {company?.description ||
            "Workspace pronto para organizar sua equipe."}
        </p>
