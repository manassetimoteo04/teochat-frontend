...
export function ChatChannels() {
  ...
  return (
    <div className="h-[calc(100dvh-5.5rem)] overflow-hidden border-r bg-main-bg-color-2">
      {isPending && <Spinner />}

      {!isPending && (
        <>
          <header className="h-[12rem] flex flex-col gap-[1rem] border-b p-[2rem] bg-main-bg-color-2">
